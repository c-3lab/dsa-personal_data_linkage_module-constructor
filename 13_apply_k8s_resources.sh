...
kubectl wait -n $NAMESPACE --timeout=300s --for=condition=available deployment/root-api
kubectl wait -n $NAMESPACE --timeout=300s --for=condition=available deployment/region000001-api
kubectl wait -n $NAMESPACE --timeout=300s --for=condition=available deployment/application000001-api
